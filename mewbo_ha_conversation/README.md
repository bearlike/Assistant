# Home Assistant Conversation Integration for Mewbo 🚀
...
- Home Assistant Conversation integration for Mewbo (works with HA Assist).
- Wrapped around the Mewbo REST API for synchronous conversations.
