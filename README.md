...
> Four access surfaces — terminal, web console, REST API, Home Assistant — driven by the same session state machine. Full docs at [docs.trusswork.co](https://docs.trusswork.co/).
...
Full docs live at **[docs.trusswork.co](https://docs.trusswork.co/)** — including setup, every client surface, the capability reference, deployment guides, and the internals/SDK track. The source lives under [`docs/`](docs/) and is published with MkDocs.

If you are just getting started, jump to [Get Started](https://docs.trusswork.co/getting-started/).
