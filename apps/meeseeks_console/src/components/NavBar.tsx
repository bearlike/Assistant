...
export function NavBar({
  ...
  const ShareMenu = () =>
  <div className="absolute top-full right-0 mt-2 w-44 bg-[hsl(var(--popover))] border border-[hsl(var(--border))] rounded-lg shadow-2xl shadow-black/40 ring-1 ring-white/[0.03] overflow-hidden z-50">
      <button
      onClick={() => {
      ...
      className="w-full text-left px-3 py-2 text-xs text-[hsl(var(--foreground))] hover:bg-[hsl(var(--accent))] transition-colors">
    ...
    <header className="sticky top-0 z-50 w-full h-12 border-b border-[hsl(var(--border-strong))] bg-[hsl(var(--background))]/95 backdrop-blur flex items-center justify-between px-4">
      ...
      <>
          ...
          <div className="flex items-center gap-1.5">
            <button className="px-2 py-1.5 text-xs font-medium text-[hsl(var(--muted-foreground))] hover:text-[hsl(var(--foreground))] transition-colors rounded-lg hover:bg-[hsl(var(--accent))]">
              Settings
            </button>
            <a
      ...
      <>
          <div className="flex items-center gap-4 overflow-hidden min-w-0 flex-1">
            <button
            onClick={onBack}
            className="p-1 hover:bg-[hsl(var(--accent))] rounded transition-colors text-[hsl(var(--muted-foreground))] hover:text-[hsl(var(--foreground))]">

              <ArrowLeft className="w-4 h-4" />
            </button>

            <div className="flex flex-col min-w-0 max-w-[320px] md:max-w-[420px]">
