...
bind-mounted ``/truss/deadline`` file and sends ``kill 1`` once the wall
...
WATCHDOG_CMD = (
    "(while [ $(date +%s) -lt $(cat /truss/deadline) ]; do sleep 15; done; "
    "kill 1) & "
...
class IdeInstance:
    ...
    def container_name(self) -> str:
        ...
        return f"truss-ide-{self.session_id}"
...
class IdeManager:
    ...
    def stop(self, session_id: str) -> bool:
        ...
        self._validate_session_id(session_id)
        container_name = f"truss-ide-{session_id}"
    ...
    def _run_container(self, instance: IdeInstance) -> None:
        ...
        labels = {
            "truss.kind": "web-ide",
            "truss.session_id": instance.session_id,
            "truss.project_name": instance.project_name,
            "truss.created_at": instance.created_at.isoformat(),
            "truss.max_deadline": instance.max_deadline.isoformat(),
        }
        volumes = {
