...
mailbox becomes a Mewbo chat channel.  New emails start sessions;
...
* **Multi-party** threads require ``@Mewbo`` in the body.
"""
...
class EmailAdapter:
    """Channel adapter that bridges an email mailbox to Mewbo sessions.
    ...
    def requires_mention(self, message: InboundMessage) -> bool:
        """Return True when @Mewbo must appear in the message.
    ...
    def _build_thread_headers(
        ...
        subject = meta.subject if meta else "Mewbo"
    ...
    def system_context(self) -> str:
        ...
        from mewbo_api.channels.routes import _COMMANDS
