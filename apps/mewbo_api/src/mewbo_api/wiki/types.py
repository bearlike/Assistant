...
# ``IndexingJob`` can reference it). The duplicate definition at line
# ~447 is kept for backwards compatibility with the discriminated event
# union below; both literals are structurally identical, so consumers
# get the same type either way.
