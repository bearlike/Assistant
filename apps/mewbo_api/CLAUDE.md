...
- Realtime endpoints (`init_realtime`; registers `/v1/draft/stream` only — the former `/v1/structured/fast` sibling was folded into `/v1/structured` as `mode:"synthesis"` by #85):
