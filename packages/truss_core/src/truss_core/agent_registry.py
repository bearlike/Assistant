#!/usr/bin/env python3
"""Agent definition registry for the Truss assistant.
...
tell Truss what sub-agents are available, what tools they may use, and what their
...
from truss_core.capabilities import (
...
def map_cc_tool_names(cc_names: list[str]) -> list[str]:
    """Map a list of CC tool names to Truss tool IDs.
