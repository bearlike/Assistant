...
description: Use when the user asks to render, build, visualise, mock up, or show a widget (chart, dashboard, card, table, graph) in the Truss Console. Teaches how to delegate the work to the st-widget-builder sub-agent instead of writing HTML or inline code yourself.
...
gh search repos --json name,description,stargazerCount,language,url \
    --limit 10 "topic:streamlit" > /tmp/truss_gh_results.json
```
