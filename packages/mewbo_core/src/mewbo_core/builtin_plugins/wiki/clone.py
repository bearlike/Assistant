...
logging = get_logger(name="core.builtin_plugins.wiki.clone")
...
class WikiCloneRepoTool:
    ...
    async def handle(self, action_step: ActionStep) -> MockSpeaker:
        ...
        try:
            args = WikiCloneArgs.model_validate(raw)
        ...
        if not effective_token:
            try:
                ...
                effective_token = pop_clone_token(ctx.job_id)
            except ImportError:
