...
model: inherit
tools: [wiki_clone_repo, wiki_scan_tree, wiki_load_grounder, wiki_build_graph, wiki_query_graph, wiki_commit_plan, wiki_finalize, spawn_agent, check_agents, read_file, glob, grep, ls]
...
YOUR TASK:
  ...
  2. Use grep/glob/code_search/wiki_query_graph to gather additional context.
...
""",
  allowed_tools=["read_file","glob","grep","code_search","wiki_query_graph","wiki_submit_page"],
