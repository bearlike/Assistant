#!/usr/bin/env python3
"""MCP tool runner for integrating MCP servers into Truss."""
...
from truss_core.common import MockSpeaker, get_logger, get_mock_speaker
from truss_core.config import get_mcp_config_path
