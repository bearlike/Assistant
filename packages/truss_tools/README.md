...
Tool implementations and integrations for Truss. This package ships the built‑in local tools (file read/list/edit, shell) plus integrations for Home Assistant and MCP.
