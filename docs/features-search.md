...
Ask a question in plain English and Mewbo searches across everything you've connected. Sub-agents fan out across a workspace's MCP servers (code hosts, ticket trackers, chat, docs, the web), gather what's relevant, and bring back one ranked, synthesised answer with citations and a trace of every source it searched.
