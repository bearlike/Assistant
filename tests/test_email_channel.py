...
from truss_api.channels.base import ChannelAdapter, InboundMessage
from truss_api.channels.email_adapter import (
    EmailAdapter,
    EmailPoller,
    _derive_thread_id,
...
def _make_email(
    *,
    ...
    to_addr: str = "truss@example.com",
    cc: str | None = None,
    subject: str = "Test Subject",
    body: str = "Hello, Truss!",
...
class TestParseEmail:
    ...
    def test_basic_email(self) -> None:
        ...
        assert result.text == "Hello, Truss!"
    ...
    def test_allowed_recipients_rejects_wrong_address(self) -> None:
        adapter = _make_adapter(
            allowed_recipients=["truss@example.com"],
        )
    ...
    def test_allowed_recipients_accepts_matching_address(self) -> None:
        ...
        msg = _make_email(to_addr="truss@example.com")
        result = adapter.parse_email(msg)
        assert result is not None
...
class TestRequiresMention:
    ...
    def test_trigger_keyword_is_at_truss(self) -> None:
        adapter = _make_adapter()
        assert adapter.trigger_keyword == "@Truss"
...
class TestSendResponse:
    ...
    @patch("truss_api.channels.email_adapter.smtplib.SMTP")
    ...
    @patch("truss_api.channels.email_adapter.smtplib.SMTP_SSL")
...
class TestMarkdownRendering:
    ...
    def test_email_template_wraps(self) -> None:
        ...
        assert "Truss" in html  # Header branding
...
class TestEmailPoller:
    ...
    @patch("truss_api.channels.email_adapter.imapclient.IMAPClient")
    def test_poll_loop_processes_unseen(
        ...
        test_email = _make_email(body="@Truss do something")
        ...
        assert call_args[1].text == "@Truss do something"
