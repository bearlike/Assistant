...
from truss_tools.integration.lsp.servers import (
    BUILTIN_SERVERS,
    ServerDef,
    available_servers,
)
...
class TestLSPServerManager:
    def test_manager_creates_extension_map(self):
        ...
        from truss_tools.integration.lsp.manager import LSPServerManager
        ...
        with patch(
            "truss_tools.integration.lsp.manager.available_servers",
...
class TestLSPToolFormatting:
    def test_format_diagnostics_empty(self):
        ...
        from truss_tools.integration.lsp.tool import LSPTool
...
class TestLSPToolRegistration:
    def test_lsp_tool_in_default_registry(self, monkeypatch):
        ...
        monkeypatch.setenv("TRUSS_HOME", "/tmp/truss-test-lsp")
        from truss_core.config import reset_config

        reset_config()

        from truss_core.tool_registry import _default_registry
