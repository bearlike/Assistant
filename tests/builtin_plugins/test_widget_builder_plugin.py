...
``truss_core/builtin_plugins/widget_builder/``. Keeping them integration-
...
def _plugin_root() -> Path:
    traversable = importlib.resources.files("truss_core") / "builtin_plugins" / "widget_builder"
...
class TestManifest:
    def test_manifest_parses_with_stlite_capability(self):
        from truss_core.plugins import parse_plugin_manifest
...
class TestAgentAndSkill:
    def test_skill_parses_with_agent_and_capability(self):
        ...
        from truss_core.skills import _parse_skill_file
    ...
    def test_agent_parses_with_submit_widget_and_capability(self):
        from truss_core.agent_registry import parse_agent_file
...
def test_capability_gating_hides_agent_without_stlite():
    from truss_core.agent_registry import (
        AgentRegistry,
        parse_agent_file,
    )
