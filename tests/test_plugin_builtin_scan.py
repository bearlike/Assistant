...
inside the ``meeseeks_core.builtin_plugins`` package directory are discovered
...
import pytest
from meeseeks_core import plugins as plugins_module
...
def test_load_all_plugin_components_builtin_before_installed(
    ...
    from meeseeks_core.plugins import PluginComponents, PluginManifest
